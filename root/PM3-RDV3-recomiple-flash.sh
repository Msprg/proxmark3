...
# regenerate version_pm3.c from current git (CMake only tracks default_version_pm3.c,
# so ninja alone keeps a stale hash and the flash aborts on version mismatch)
rm -f "$CLIENT_BUILD/version_pm3.c"
